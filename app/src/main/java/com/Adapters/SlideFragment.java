...
import com.models.SliderViewModel;
...
public class SlideFragment extends Fragment {
    ...
    private static final int[] PAGE_IMAGE =
            new int[]{
                    R.drawable.sharesavebanner, R.drawable.sharebanner, R.drawable.formagroup
            };
    ...
    public View onCreateView(
        ...
        sliderViewModel.getText().observe(getActivity(), new Observer<Integer>() {
            @Override
