...
public class AutoStartHelper {
    ...
    public void getAutoStartPermission(Context context) {
     /*   sharedpreferences = context.getSharedPreferences(context.MyPREFERENCES, MODE_PRIVATE);
        editor = context.getSharedPreferences(context.MyPREFERENCES, MODE_PRIVATE).edit();*/
